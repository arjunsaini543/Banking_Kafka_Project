...
"""
                ...
                print("----------------------------------------")
                print(
                    "Uploading file to Snowflake stage:"
                )
                print(file_path)
                print("----------------------------------------")
            ...
            print("----------------------------------------")
            print(
                f"Copying files into {target_table}"
            )
            print("----------------------------------------")
